import type { CharacterOriginJson } from "@/types/json/JsonDataTypes";

export function createOriginData(): CharacterOriginJson[] {
	return [
		createAgriWorldOrigin(),
		createFeralWorldOrigin(),
		createFeudalWorldOrigin(),
		createForgeWorldOrigin(),
		createHiveWorldOrigin(),
		createScholaProgeniumOrigin(),
		createShrineWorldOrigin(),
		createVoidbornOrigin(),
	];
}

function createStrengthBonus(amount = 5) {
	return createBonus("Strength", amount);
}

function createToughBonus(amount = 5) {
	return createBonus("Tough", amount);
}

function createAgilityBonus(amount = 5) {
	return createBonus("Agility", amount);
}

function createWillpowerBonus(amount = 5) {
	return createBonus("Willpower", amount);
}

function createIntelligenceBonus(amount = 5) {
	return createBonus("Intelligence", amount);
}

function createFellowshipBonus(amount = 5) {
	return createBonus("Fellowship", amount);
}

function createPerceptionBonus(amount = 5) {
	return createBonus("Perception", amount);
}

function createBallisticSkillBonus(amount = 5) {
	return createBonus("Ballistic Skill", amount);
}

function createWeaponSkillBonus(amount = 5) {
	return createBonus("Weapon Skill", amount);
}

function createBonus(name: string, amount: number) {
	return {
		characteristic: name,
		bonus: amount,
	};
...
function createFeudalWorldOrigin(): CharacterOriginJson {
	return {
		...
		characteristicBonuses: {
			base: [createWeaponSkillBonus()],
			choice: [createStrengthBonus(), createWillpowerBonus(), createFellowshipBonus()],
		},
		equipmentBonuses: [
			{
				quality: "Shoddy",
				equipmentName: "Writing Kit",
			},
		],
	};
}

function createForgeWorldOrigin(): CharacterOriginJson {
	return {
		roll: { min: 31, max: 40 },
		name: "Forge World",
		description:
		...
		characteristicBonuses: {
			base: [createIntelligenceBonus()],
			choice: [createBallisticSkillBonus(), createToughBonus(), createAgilityBonus()],
		},
		equipmentBonuses: [
			{
				equipmentName: "Sacred Unguents",
			},
		],
	};
}

function createHiveWorldOrigin(): CharacterOriginJson {
	return {
		roll: { min: 41, max: 70 },
		name: "Hive World",
		description:
		...
		characteristicBonuses: {
			base: [createAgilityBonus()],
			choice: [createBallisticSkillBonus(), createPerceptionBonus(), createFellowshipBonus()],
		},
		equipmentBonuses: [
			{
				quality: "Ugly",
				equipmentName: "Filtration Plugs",
			},
		],
	};
}

function createScholaProgeniumOrigin(): CharacterOriginJson {
	return {
		roll: { min: 71, max: 80 },
		...
		characteristicBonuses: {
			base: [createFellowshipBonus()],
			choice: [createWeaponSkillBonus(), createBallisticSkillBonus(), createToughBonus()],
		},
		equipmentBonuses: [
			{
				equipmentName: "Chrono",
			},
		],
	};
}

function createShrineWorldOrigin(): CharacterOriginJson {
	return {
		roll: { min: 81, max: 90 },
		name: "Shrine World",
		description:
		...
		characteristicBonuses: {
			base: [createWillpowerBonus()],
			choice: [createIntelligenceBonus(), createPerceptionBonus(), createFellowshipBonus()],
		},
		equipmentBonuses: [
			{
				equipmentName: "Holy Icon",
			},
		],
	};
}
function createVoidbornOrigin(): CharacterOriginJson {
	return {
		roll: { min: 91, max: 0 },
		name: "Voidborn",
		description:
		...
		characteristicBonuses: {
			base: [createPerceptionBonus()],
			choice: [createAgilityBonus(), createIntelligenceBonus(), createWillpowerBonus()],
		},
		equipmentBonuses: [
			{
				quality: "Shoddy",
				equipmentName: "Mag Boots",
			},
		],
	};
}
